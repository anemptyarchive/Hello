...
m <- gganimate::animate(
  ...
  renderer = gganimate::av_renderer(file = "ChartRace/output/PeriodJoinGroup/PeriodJoinGroup_mean.mp4")
)
...
# 画像を書出
ggplot2::ggsave(
  filename = paste0("ChartRace/output/PeriodJoinGroup_mean_", date_val, ".png"), plot = graph, 
